...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-zinc-50 via-stone-100 to-amber-50/40 pt-20 sm:pt-8 flex flex-col justify-between overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex-1 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-12 lg:py-20">
        <div className="space-y-8 max-w-xl z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-zinc-900 tracking-tight leading-tight sm:leading-none">
            ...
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-900 via-zinc-700 to-amber-600">
              Premium Quality.
            </span>
          </h1>
